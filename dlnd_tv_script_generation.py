...
def build_rnn(cell, inputs):
    ...
    """
    #cell, initialize_state = get_init_cell()
...
def get_batches(int_text, batch_size, seq_length):
    ...
    for i in range(number_of_batches):
        ...
        for j in range(batch_size):
            ...
            #Batch of targets
            batche_target.append(int_text[start + 1:end + 1])
        batche_item.append(batche_input)
        batche_item.append(batche_target)
        batches.append(batche_item)
    # TODO: Implement Function
